...
September 13: east/west idle and east start/stop are selected. The eight transition frames are packaged in character/marsh-v2/supplemental/ground-east and used by the production Marsh controller. Current scope and verification: docs/HANDOFF_MARSH_GROUND_TRANSITIONS_2026-09-13.md. Candidate-named source recipes remain provenance; their runtime selection is the supplemental contract.

Short step is now selected for 3.5-4.5-unit empty-goal dry east routes. See docs/HANDOFF_MARSH_SHORT_STEP_2026-09-13.md for production and Save/Continue evidence. Candidate-named recipes preserve source history; runtime selection is defined by the supplemental contract.
