# Historical development notes — doctrine/directive prototype

Archived during the September 7, 2026 guidance cleanup. Original passages below
retain their historical wording, including headings such as “Remaining priorities”
and “A Good Next Session”; none is a current work instruction. They describe an
earlier prototype and its evidence. Some later limits were interleaved in that text
and also require verification before reuse. Relative links retain their original
docs/ base and are adjusted here for the archive location.

Starting doctrines, timed directives and scenario victory were subsequently retired
at the owner's request. Use [current status](../CURRENT_STATUS.md) for active work.
