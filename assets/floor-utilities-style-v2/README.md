# floor-utilities-style-v2 — refreshed collection

13 reusable decorations restyled against the established BrineSpace room art.
This revision supersedes `floor-utilities-v1` for future asset use; the earlier pack remains
