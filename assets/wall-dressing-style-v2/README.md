# wall-dressing-style-v2 — refreshed collection

24 reusable decorations restyled against the established BrineSpace room art.
This revision supersedes `wall-dressing-style-v1` for future asset use; the earlier pack remains
...
All 24 subjects now use revised art: six accepted revisions from the preceding pass, plus eighteen revisions in this pass. Historical style_status fields in original prompts describe the earlier audit only. Lamps, clocks and readouts are static illustrations.
