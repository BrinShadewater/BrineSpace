extends SceneTree
const Kit=preload("res://assets/wall-dressing-style-v2/wall_sprites.gd")
...
func run() -> void:
	...
	if DisplayServer.get_name()!="headless":
		...
		for layout_mode in [false]:
			...
			root.get_texture().get_image().save_png("res://assets/wall-dressing-style-v2/"+("wall-layouts.png" if layout_mode else "preview.png"))
