# floor-dressing-style-v2 — refreshed collection

16 reusable decorations restyled against the established BrineSpace room art.
This revision supersedes `floor-dressing-v1` for future asset use; the earlier pack remains
...
The atlas incorrectly turned the plant drip tray into a window. That region is rejected; `source/plant-drip-tray-v3.png` supplies the corrected tray. Its prompt and hash are included separately.
