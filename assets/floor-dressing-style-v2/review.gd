extends SceneTree
const Kit=preload("res://assets/floor-dressing-style-v2/floor_dressing.gd")
...
func run() -> void:
	...
	if DisplayServer.get_name()!="headless":
		...
		root.get_texture().get_image().save_png("res://assets/floor-dressing-style-v2/preview.png")
