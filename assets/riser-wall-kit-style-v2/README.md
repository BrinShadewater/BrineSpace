# riser-wall-kit-style-v2 — refreshed collection

12 reusable decorations restyled against the established BrineSpace room art.
This revision supersedes `riser-wall-kit-v1` for future asset use; the earlier pack remains
