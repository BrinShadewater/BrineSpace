...
s=(root/'tools/capture_galley_furnishing_states.gd').read_text()
...
s=s.split('\tvar canvases=[]')[0]+'\tprint("GALLEY CREW SCALE: production Bill reference, four orientations")\n\tquit()\n'
(root/'tools/capture_galley_crew_scale.gd').write_text(s)
