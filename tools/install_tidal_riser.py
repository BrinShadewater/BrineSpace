...
entry=dict(base);entry.update(source='res://assets/tidal-owner-v2/riser.png',sha256=hashlib.sha256(target.read_bytes()).hexdigest(),review='Tidal grey-blue panel and dull-brass pipe repaint; original face/cap rectangles retained')
