extends SceneTree
const View = preload("res://rooms/full-wall-v1/mycelium_nursery_view.gd")
...
const MedView = preload("res://rooms/full-wall-v1/med_bay_view.gd")
const CrewView = preload("res://rooms/full-wall-v1/crew_hab_view.gd")
