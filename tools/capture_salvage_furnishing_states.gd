...
func run() -> void:
	...
	var folder="res://output/salvage-owner-repair-2026-09-12/furnishing-states"
	...
	print("SALVAGE FURNISHING STATES: 4 rotations x off/on/two clocks, direct and retained")
	quit()
