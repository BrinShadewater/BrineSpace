"""Reconstruct Bill's coherent locker actions from their preserved source."""
import hashlib
import numpy as np
from PIL import Image

SOURCE = 'character/major-bill-v3/sources/locker-identity-2026-09-22'
...
def build(root, read, image, idle, equipped_idle):
    ...
    if hashlib.sha256(source.read_bytes()).hexdigest() != recipe['source_sha256']:
        raise ValueError('Bill locker source changed')
