"""Mute painted orange in the accepted Current Turbine side and south sources."""
...
SOURCES = {
    "turbine-sides-muted-v1.png": ROOT
    / "assets/turbine-directional-v3/east-overhead-clean.png",
    "turbine-south-muted-v1.png": ROOT
    / "assets/turbine-directional-v1/turbine-south.png",
}
DEFAULT_OUTPUT_DIR = ROOT / "assets/turbine-directional-v4"
