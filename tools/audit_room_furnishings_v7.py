"""Audit the six v7 sources, registrations, cards, profiles, and native views."""
...
MANIFEST = ROOT / "assets/room-furnishings-v7/manifest.json"
...
def main() -> None:
    ...
    summary = {
        "assets": len(data["assets"]), "themed": sum(item["scope"] == "themed" for item in data["assets"]),
        ...
        "native_orientations": sum(len(value) for value in views.values()), "errors": errors,
    }
