"""Prepare canonical Veld east seating poses; selection remains ledger-owned."""
...
def main():
    source=BASE/'sources/seated-east-body-02.png'
    ...
    reference=Image.open(BASE/'review/east-chain-01/idle-east-000.png').convert('RGBA')
    ...
    rows={'sit-down-east':down,'sit-idle-east':idle,'sit-rise-east':list(reversed(down))}
    out=BASE/'review/seated-east-body-01';out.mkdir(exist_ok=True)
    ...
    print('Prepared 18 unselected east seating frames, one anatomical ruler and corrected standing endpoints.')
