...
func run() -> void:
	...
	assert(source.load_png_from_buffer(FileAccess.get_file_as_bytes("res://rooms/underwater/l-shaped-studies/culture-clean-v1.png"))==OK)
	...
	assert(straight_image.load_png_from_buffer(FileAccess.get_file_as_bytes("res://rooms/underwater/l-shaped-studies/culture-straight-clean-v1.png"))==OK)
	...
	assert(root.get_texture().get_image().save_png("res://rooms/underwater/l-shaped-studies/culture-room-v3.png")==OK)
