...
class Composition extends Node2D:
	...
	func _draw() -> void:
		...
		var source_region:=Rect2(1018,604,228,505)
...
func run() -> void:
	...
	assert(source.load_png_from_buffer(FileAccess.get_file_as_bytes("res://legacy/default/rooms/underwater/l-shaped-studies/culture-clean-v1.png"))==OK)
	...
	assert(straight_image.load_png_from_buffer(FileAccess.get_file_as_bytes("res://legacy/default/rooms/underwater/l-shaped-studies/culture-straight-clean-v1.png"))==OK)
	...
	assert(root.get_texture().get_image().save_png("res://legacy/default/rooms/underwater/l-shaped-studies/culture-room-v3.png")==OK)
	print("CULTURE L ROOM COMPOSITION PASS")
	quit()
