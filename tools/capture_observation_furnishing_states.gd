...
func run() -> void:
	...
	var folder="res://output/observation-owner-repair-2026-09-12/furnishing-states"
	...
	print("OBSERVATION FURNISHING STATES: 4 rotations x off/on/two clocks, direct and retained")
	quit()
