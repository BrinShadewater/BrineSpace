...
UPDATES = {
    "shield-pressure-wall.json": (
        ...
        "res://assets/shield-directional-v2/shield-north-muted-v1.png",
    ...
    "side-shield-pressure-wall-east.json": (
        ...
        "res://assets/shield-directional-v2/shield-sides-muted-v1.png",
    ...
    "side-shield-pressure-wall-south.json": (
        ...
        "res://assets/shield-directional-v2/shield-south-muted-v1.png",
