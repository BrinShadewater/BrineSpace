...
const DOCTRINES := {
	"industry": {
		...
		"rooms": ["reactor", "battery_array", "mining_drone_bay", "salvage_drone_bay", "ore_refinery", "storage_bay", "maintenance_bay", "shield_generator"],
	...
	"biosphere": {
		...
		"rooms": ["hydroponics_bay", "life_support", "biodome", "bio_lab", "crew_hab", "crew_lounge"],
	...
	"science": {
		...
		"rooms": ["research_lab", "data_archive", "radio_lab", "command_center", "holographic_core", "xeno_lab", "anomaly_lab"],
	...
	"recovery": {
		...
		"rooms": ["crew_hab", "crew_lounge", "cryo_chamber", "clone_lab", "med_bay", "med_center", "med_office", "life_support", "quarantine_cell"],
	...
	"anomaly": {
		...
		"rooms": ["xeno_lab", "anomaly_lab", "quarantine_cell", "research_lab", "holographic_core", "shield_generator"],
