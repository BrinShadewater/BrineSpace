...
void fragment() {
	...
	for entry in [["walls","WALLS/BASE","Show or hide room shells and station foundations"],["sprinklers","SPRINKLERS","Suppress burning rooms using emergency power and stored Water (1 per 5 seconds per room)"],["doors","DOORS","Lock/unlock internal crew doors. Drone transfers hold while locked; airlock safety cycles remain separate."],["interior","INT. LIGHTS","Turn room lighting on/off"],["exterior","EXT. LIGHTS","Turn exterior marker lights on/off"],["pumps","PUMPS","Enable powered bilge drainage and water-producing rooms"]]:
