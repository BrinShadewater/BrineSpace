...
func run() -> void:
	...
	for path in ["res://legacy/default/assets/environment/sea-lettuce-v1/sea-lettuce-rosette-v1.png","res://legacy/default/assets/environment/low-growth-v1/seagrass-rosette-v2.png","res://legacy/default/assets/environment/sub-biomes-v1/kelp-ribbon-kelp-v1.png"]:
