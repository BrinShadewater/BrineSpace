...
class Sheet extends Control:
	...
	func _draw() -> void:
		...
		var names := ["Sea lettuce","Seagrass","Ribbon kelp"]
...
func run() -> void:
	...
	for path in ["res://assets/environment/sea-lettuce-v1/sea-lettuce-rosette-v1.png","res://assets/environment/low-growth-v1/seagrass-rosette-v2.png","res://assets/environment/sub-biomes-v1/kelp-ribbon-kelp-v1.png"]:
		var source := Image.new()
		if source.load(path) != OK: push_error("Failed to load image (tests/playtest_sea_lettuce.gd:31)")
	...
	DirAccess.make_dir_recursive_absolute("res://output/sea-lettuce-v1")
	assert(frame.save_png("res://output/sea-lettuce-v1/plant-scale.png")==OK)
	print("SEA LETTUCE STUDY PASS: three alpha sources; three cell widths; source and runtime tint; 1600x900")
	quit()
