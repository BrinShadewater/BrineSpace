...
func run() -> void:
	...
	var paths := ["res://legacy/default/assets/environment/ripple-sand-v1/ripple-sand-v1.png","res://legacy/default/assets/environment/service-wreckage-v1/collapsed-support-v1.png","res://legacy/default/assets/environment/shell-shoal-v1/limestone-cobbles-v1.png"]
