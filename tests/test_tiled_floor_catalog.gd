...
const IDS=["pressure_control", "crew_lounge", "mining_drone_bay", "ore_refinery", "listening_post", "xeno_lab", "maintenance_bay", "bio_lab", "isolation_vault", "current_turbine", "biomass_digester", "heat_recovery", "airlock", "construction_drone_bay", "brine_core", "solar_array", "battery_array", "salvage_drone_bay", "gravity_loom", "data_archive", "biodome", "anomaly_lab", "command_center", "holographic_core", "med_center", "med_office", "radio_lab", "shield_generator"]
func _init() -> void: call_deferred("run")
func frame() -> void: await process_frame; RenderingServer.force_draw()
func run() -> void:
	DirAccess.make_dir_recursive_absolute("res://output/tiled-floor-catalog")
