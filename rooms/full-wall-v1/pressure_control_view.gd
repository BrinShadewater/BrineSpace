extends "res://rooms/underwater/rare-dead-ends/pressure_control_view.gd"
...
var full_wall = preload("res://rooms/full-wall-v1/full_wall_prop.gd").new("pressure-manifold-wall")
...
func draw_prop_animation(prop: Dictionary) -> void:
	if Effects.owns(prop):
		Effects.draw(self,prop,false)
		return
