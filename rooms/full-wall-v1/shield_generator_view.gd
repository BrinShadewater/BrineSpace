extends "res://rooms/underwater/hull-integrity/shield_generator_view.gd"
## Balanced full-wall installation; original view is the reversible baseline.
var full_wall = preload("res://rooms/full-wall-v1/full_wall_prop.gd").new("shield-pressure-wall")
