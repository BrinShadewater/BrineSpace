...
func _ready() -> void:
	super._ready()
	var image := Image.new()
	preload("res://scripts/safe_image.gd").load_png(image, "res://legacy/default/assets/rooms/gravity-loom/source/overhead.png")
	...
	dressing=Dressing.new(self,"res://rooms/underwater/gravity-loom/loom-composition-v3.json")
	rebuild()
