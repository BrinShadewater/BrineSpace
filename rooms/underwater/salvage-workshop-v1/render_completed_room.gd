...
func run() -> void:
	...
	assert(root.get_texture().get_image().save_png("res://legacy/default/rooms/underwater/salvage-workshop-v1/completed-room.png")==OK)
	...
	for path in ["res://rooms/underwater/salvage-workshop-v1/workshop_view.gd","res://assets/rooms/observation-room/office/render_completed_room.gd"]:
