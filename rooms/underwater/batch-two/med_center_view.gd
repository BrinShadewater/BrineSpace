...
func _ready() -> void:
	...
	if source.load_png_from_buffer(FileAccess.get_file_as_bytes("res://assets/material-polish-medical-v3/center-equipment.png")) != OK: push_error("Failed to load image (rooms/underwater/batch-two/med_center_view.gd)")
