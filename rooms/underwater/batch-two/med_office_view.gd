...
func _ready() -> void:
	...
	preload("res://scripts/safe_image.gd").load_png(source, "res://legacy/default/assets/rooms/med-office/source/office-equipment.png")
	...
	office_dressing=OfficeDressing.new(self,"res://rooms/underwater/batch-two/med-office-composition-v3.json")
	rebuild()
