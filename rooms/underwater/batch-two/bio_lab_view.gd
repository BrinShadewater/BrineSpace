...
func _ready() -> void:
	...
	if source.load_png_from_buffer(FileAccess.get_file_as_bytes("res://rooms/underwater/batch-two/bio_lab-source-v1.png")) != OK: push_error("Failed to load image (rooms/underwater/batch-two/bio_lab_view.gd:9)")
