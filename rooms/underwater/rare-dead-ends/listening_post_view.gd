...
func _ready() -> void:
	...
	preload("res://scripts/safe_image.gd").load_png(equipment_image,"res://legacy/default/assets/rooms/listening-post/source/listening-equipment.png")
	equipment_texture=ImageTexture.create_from_image(equipment_image)
	var flush_image:=Image.new()
	preload("res://scripts/safe_image.gd").load_png(flush_image, "res://legacy/default/assets/rooms/listening-post/source/listening-u-flush-clean-v1.png")
