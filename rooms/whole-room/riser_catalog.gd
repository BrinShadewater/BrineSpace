...
static func catalog() -> Dictionary:
	if registrations.is_empty(): registrations=JSON.parse_string(FileAccess.get_file_as_string("res://assets/riser-departments-v1/registrations.json"))
