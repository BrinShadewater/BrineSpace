extends SceneTree
const Kit=preload("res://archive/assets/riser-wall-kit-v1/wall_sprites.gd")
...
func run() -> void:
	...
	if DisplayServer.get_name()!="headless":
		...
		for layout_mode in [false,true]:
			...
			root.get_texture().get_image().save_png("res://assets/riser-wall-kit-v1/"+("wall-layouts.png" if layout_mode else "preview.png"))
