...
GAPS={'specimen_alignment_ring':[(1068,480),(981,450),(1135,413),(1135,547),(1001,547)]}
...
for key,region,width,department,placement in ITEMS:
    ...
    clean=cleanup.clear_exterior(source.crop(region),seeds)
...
manifest={'version':1,'source':{'path':source_path.relative_to(ROOT).as_posix(),'size':source.size,'mode':source.mode,'sha256':sha(source_path)},'sprites':sprites}
